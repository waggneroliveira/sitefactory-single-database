                        ...
                        <div class="right-content col-11 m-auto col-lg-6 py-5 px-2 px-md-4 px-lg-5">
                            ...
                            @if ($statute->btn_number <> null)                    
                                <div class="step-actions mt-4 d-flex justify-content-center justify-content-lg-start">
                                    <a href="{{$statute->btn_number}}" target="_blank" rel="noopener noreferrer" class="rounded-2 py-2 px-3 px-lg-5 font-changa bg-button-two color-button-two font-18 font-medium text-decoration-none hover-zoom" rel="noopener noreferrer">
                                        {{$statute->btn_title}}
                ...
                <div class="row justify-content-center align-items-center">
                    ...
                    <div class="content-left col-12 col-lg-6">
                        ...
                        <div class="step-actions gap-3 d-flex mt-4 flex-wrap justify-content-center justify-content-lg-start">
                            <a href="{{route('about')}}#coverage-section" class="rounded-2 py-2 px-4 hover-zoom btn-hero font-changa color-button-two bg-button-two font-18 font-medium text-decoration-none" rel="noopener noreferrer">
                                Onde Distribuimos
                            ...
                            <a href="{{route('about')}}#team-section" class="rounded-2 py-2 px-4 hover-zoom btn-hero font-changa color-button-two bg-button-two font-18 font-medium text-decoration-none" rel="noopener noreferrer">
        ...
        <section class="blog position-relative">
            ...
            <div class="container z-3 position-relative">
                ...
                <div class="step-actions mt-4 d-flex justify-content-center justify-content-lg-end">
                    <a href="{{route('blogAll')}}" class="rounded-2 px-4 btn font-changa  text-white font-18 font-medium text-decoration-none" rel="noopener noreferrer">
                        ...
                        <div class="col-lg-5">
                            ...
                            @if ($sessaoFaq->btn_title <> null && $sessaoFaq->btn_number <> null)                
                                <div class="d-flex justify-content-center justify-content-lg-start align-items-center">
                                    <a href="{{$sessaoFaq->btn_number}}" class="bg-button-two color-button-two btn-product rounded-2 py-2 px-4 text-white hover-zoom">
                                        {{$sessaoFaq->btn_title}}
