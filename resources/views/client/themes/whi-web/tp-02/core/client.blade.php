...
<head>
    ...
    <link href="{{ asset('build/client/themes/whi-web/tp-02/css/style.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('build/client/themes/whi-web/tp-02/css/responsivo.css') }}" rel="stylesheet" type="text/css">
