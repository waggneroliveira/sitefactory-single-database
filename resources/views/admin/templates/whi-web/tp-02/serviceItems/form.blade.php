        ...
        {{-- <div class="row">
            <div class="col-12 col-md-6 mb-3">
                ...
                >
                    ...
                    <option
                        value="scroll"
                        {{ isset($serviceItem) && !empty($serviceItem->scroll_section) ? 'selected' : '' }}
                    >
                        Rolagem (Scroll)
                    </option>
                </select>
            ...
            <div class="col-12 col-md-6 mb-3 scroll-field d-none">
                <label for="scroll_section{{ isset($serviceItem->id) ? $serviceItem->id : '' }}" class="form-label">
                    Seção para rolagem
                </label>
                ...
                <input
                    type="text"
                    name="scroll_section"
                    id="scroll_section{{ isset($serviceItem->id) ? $serviceItem->id : '' }}"
                    class="form-control"
