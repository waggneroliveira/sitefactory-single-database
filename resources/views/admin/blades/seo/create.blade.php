    ...
    <div class="content-page">
        <div class="content">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <form action="{{route('admin.dashboard.seoGoogle.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf

                        <div class="row">
                            @includeIf("admin.blades.seo.form", ['textareaId' => 'textarea-create', 'seoGoogle', 'themeData'])
                        </div>
                        ...
                        Auth::user()->hasRole('Super') || Auth::user()->hasPermissionTo('sobre nos.visualizar') && Auth::user()->hasPermissionTo('sobre nos.criar'))
                            <div class="d-flex justify-content-end gap-2">
                                <a href="{{route('admin.dashboard.seoGoogle.index')}}" class="btn btn-danger waves-effect waves-light">{{__('dashboard.btn_cancel')}}</a>
