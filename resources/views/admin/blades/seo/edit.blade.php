    ...
    <div class="content-page">
        <div class="content">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <form action="{{ route('admin.dashboard.seoGoogle.update', ['seoGoogle' => $seoGoogle->id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')

                        <div class="row">
                            @includeIf("admin.blades.seo.form", ['seoGoogle', 'themeData'])    
                        </div>
