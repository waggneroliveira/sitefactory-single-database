                            ...
                            <div class="row mb-2">
                                <div class="col-12 d-flex justify-between">
                                    ...
                                    <div class="col-6 d-flex justify-content-end">
                                        @if (Auth::user()->hasRole('Super') || Auth::user()->can('usuario.tornar usuario master') || Auth::user()->can(['tenant.visualizar', 'tenant.criar']))
                                    ...
                                    <tbody>{{-- data-route="{{route('admin.dashboard.tenant.sorting')}}" --}}
                                        <tr>{{--data-code="{{$tenant->id}}"--}}
                                            ...
                                            <td class="d-flex gap-lg-1 justify-center" style="padding: 18px 15px 0px 0px;">
                                                @if (Auth::user()->hasRole('Super') || Auth::user()->can('usuario.tornar usuario master') || Auth::user()->can(['tenant.visualizar', 'tenant.editar'])) 
