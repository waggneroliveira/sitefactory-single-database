...
return [
    ...
    'faq' => [
        'permission' => 'perguntas e respostas',
        'actions' => [
            'criar',
            'editar',
            'visualizar',
    ...
    'mission' => [
        'permission' => 'missao visao e valores',
        'actions' => [
            'criar',
            'editar',
            'visualizar',
    ...
    'product_categories' => [
        'permission' => 'categorias de produtos',
        'actions' => [
            'criar',
            'editar',
            'visualizar',
